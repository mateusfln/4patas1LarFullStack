              ...
              >
                ...
                {selectedDog === dog && (
                  <>
                    ...
                    {dog.disponibility ? <Link onClick={handleSubmitDog} href='/adoptionForm' className="bg-amber-100 text-amber-950 px-4 py-2 rounded-md hover:bg-blue-600 transition duration-300">
                      Adotar {dog.name} !
                    </Link> : ''}
