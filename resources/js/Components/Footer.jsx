      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <ul>
              <li><Link className='hover:text-amber-950 transition duration-300' href="/adopt">Adotar um Cachorro</Link></li>
              <li><Link className='hover:text-amber-950 transition duration-300' href="/donate">Doar</Link></li>
              <li><Link className='hover:text-amber-950 transition duration-300' href="/commonQuestions">Perguntas Frequentes</Link></li>
              <li><Link className='hover:text-amber-950 transition duration-300' href="/aboutUs">Sobre Nós</Link></li>
            </ul>
          </div>
